...
namespace ToyBox {
    public class BlueprintLoader {
        ...
        private List<ConcurrentDictionary<BlueprintGuid, Object>> _startedLoadingShards = new();
        ...
        internal static class BlueprintLoaderPatches {
            ...
            internal static void BlueprintsCache_Init_Patch() {
                ...
                /*
                else if (Main.Settings.togglePreloadSaveBlueprints) {
                    Shared.Load((bps) => {
                        Mod.Log("Finished SaveBP Preload");
