    ...
    public static class DiceRollsGUI {
        ...
        public static void OnGUI() {
            HStack("Dice Rolls".localize(), 1,
                ...
                () => EnumGrid("Roll With Advantage".localize(), ref Settings.rollWithAdvantage, AutoWidth()),
                () => EnumGrid("Roll With Disadvantage".localize(), ref Settings.rollWithDisadvantage, AutoWidth()),
