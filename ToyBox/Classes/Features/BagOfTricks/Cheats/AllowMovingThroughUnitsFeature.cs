...
public partial class AllowMovingThroughUnitsFeature : FeatureWIthUnitSelectTypeGrid {
    ...
    public override ref UnitSelectType SelectSetting => ref Settings.SelectionAllowMovingThroughUnits;
